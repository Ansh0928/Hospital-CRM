...
`;
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-lg p-6 shadow mb-8">
        <div className="flex items-center gap-5 mb-6">
          <div className="w-20 h-20 rounded-full border-2 border-purple-800 bg-purple-100 text-purple-900 grid place-items-center text-3xl font-bold">
            {emr[0].patient[0]}
          </div>
          <div>
        ...
        <section>
          ...
          {emr[0].recent.map((visit, i) => (
            <div
              key={i}
              className="p-3 mb-3 rounded-lg bg-purple-50 border border-purple-200"
            >
              <p>
